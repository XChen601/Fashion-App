  ...
  return (
    <div>
        ...
        <div className="content">
          <div className="text-content">
            <h1 className="type-writer">
              Effortless <span className="highlight">Style</span> At Your
              Fingertips
        ...
        <div className="content">
          <div className="text-content">
            <h1 className="type-writer part-two">
              PerfectFit prepares outfits everyday <br />
              based on Your Personal{" "}
              <span style={{ color: "red" }}>Wardrobe </span>and
      ...
      <footer className="footer">
        <Container fluid="xl">
          All Rights Reserved | CUNY TECH PREP SUMMER 2023 HACKATHON | Designed
          By Team Magic ✨
        </Container>
      </footer>
    </div>
